...
DROP TYPE IF EXISTS macro;
CREATE TYPE macro AS ENUM ('Fat', 'Protein', 'Carbohydrates');

DROP TYPE IF EXISTS meal;
CREATE TYPE meal AS ENUM ('Breakfast', 'Lunch', 'Dinner', 'Dessert', 'Snack', 'Bread and Crackers', 'Side Dish', 'Fat Bombs');

DROP TYPE IF EXISTS cuisine;
CREATE TYPE cuisine AS ENUM ('Universal', 'American', 'Chinese', 'French', 'German', 'Greek', 'Indian','Irish', 'Italian', 'Japanese', 'Korean', 'Mexican','Middle Eastern', 'Russian', 'Thai', 'Vietnamese' );
